<template>
    <div class="flex flex-wrap mb-4 relative">
        <video :src="generateVideoPreview(video)" controls preload class="rounded-lg" ></video>
        <a href="#" @click.prevent="$emit('removed', video)" class="bg-gray-900 w-8 h-8 rounded-full absolute top-0 right-0 mr-3 mt-3 flex items-center justify-center">
            <svg 
