<template>
    <div class="flex flex-wrap mb-4">
        <div
            ...
            :key="index"
            class="w-5/12 flex-grow mb-4 mr-2 relative"
        >
            <img :src="generateImagePreview(image)" class="h-50">
            <a href="#" @click.prevent="$emit('removed', image)" class="bg-gray-900 w-8 h-8 rounded-full absolute top-0 right-0 mr-3 mt-3 flex items-center justify-center">
                <svg 
